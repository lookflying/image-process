...
void PreprocessWidget::create_page_preprocess(){
    ...
    button_split_overlay_ = new QPushButton(tool_page_preprocess_);
    button_split_overlay_->setGeometry(QRect(width() / 4, 28, width() / 2, 24));
    button_split_overlay_->setText(QString::fromUtf8("&Split Overlay"));
    label_threshold_ = new QLabel(tool_page_preprocess_);
    label_threshold_->setGeometry(0, 56, width(), 24);
    label_threshold_->setText(QString::fromUtf8("Threshold"));
    slider_threshold_ = new QSlider(Qt::Horizontal, tool_page_preprocess_);
    slider_threshold_->setGeometry(QRect(0, 84, width() *3 / 4, 24));
    ...
    spin_box_threshold_->setGeometry(QRect(width() *3 / 4, 84, width() / 4, 24));
    ...
    slider_threshold_optional_->setGeometry(QRect(0, 112, width() * 3 / 4, 24));
    ...
    spin_box_threshold_optional_->setGeometry(QRect(width() * 3 / 4, 112, width() / 4, 24));
